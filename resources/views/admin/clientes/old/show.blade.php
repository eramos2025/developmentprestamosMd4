...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="nro_documento" name="nro_documento" class="form-control" placeholder="Ingresa Número de documento" value="{{ $cliente->nro_documento }}" disabled>
            </div>
            @error('nro_documento')
    ...
    <div class="col-md-6">
        <div class="form-group text-center">
            <label for="logo">Foto</label><b> (*)</b>
            <!-- <input type="file" id="foto" name="foto" accept=".jpg, .jpeg, .png" class="form-control" required> -->

                            <img src="{{ asset($cliente->foto =='images/default-avatar.png' ? 'images/default-avatar.png' : 'storage/'.$cliente->foto) }}" 
                                width="120px" 
                                alt="Imagen del Clientes"
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control" 
                       placeholder="Ingresa Nombres del Cliente"  value="{{ $cliente->nombre }}" disabled>
            </div>
            @error('nombre')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="apellido" name="apellido" class="form-control" 
                       placeholder="Ingresa Apellidos del Cliente"  value="{{ $cliente->apellido }}" disabled>
            </div>
            @error('apellido')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" id="telefono" name="telefono" class="form-control"
                       placeholder="Ingresa Teléfono" value="{{ $cliente->telefono }}" disabled>
            </div>
            @error('telefono')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" id="telefono_ref" name="telefono_ref" class="form-control"
                       placeholder="Ingresa Teléfono de Referencia" value="{{ $cliente->telefono_ref }}" disabled>
            </div>
            @error('telefono_ref')
                <small class="text-danger">{{ $message }}</small>
            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            placeholder="Introduce tu correo" value="{{ $cliente->email }}" disabled>
                        </div> 
                        @error('email')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            placeholder="Ingresa tu Número de Cuenta" value="{{ $cliente->nro_cuenta }}" disabled>
                        </div>
                        @error('nro_cuenta')
                            <small style="color:red"> {{ $message }} </small>
                        @enderror
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="ocupacion" name="ocupacion" class="form-control"
                       placeholder="Ingresa tu Ocupación" value="{{ $cliente->ocupacion }}" disabled>
            </div>
            @error('ocupacion')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="ing_mensual" name="ing_mensual" class="form-control"
                       placeholder="Ingresa tu Ingreso Mensual" value="{{ $cliente->ing_mensual }}" disabled>
            </div>
            @error('ing_mensual')
                <small class="text-danger">{{ $message }}</small>
            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            placeholder="Ingresa Comentarios" value="{{ $cliente->comentarios }}" disabled>
                        </div>
                        @error('comentarios')
                            <small style="color:red"> {{ $message }} </small>
                        @enderror
